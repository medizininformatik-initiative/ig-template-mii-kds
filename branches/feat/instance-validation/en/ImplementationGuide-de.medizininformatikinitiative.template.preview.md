# Resource MII KDS IG Template — Preview
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://github.com/medizininformatik-initiative/ig-template-mii-kds/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-preview-model.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/preview-model"
      },
      "name" : "Preview Model",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-preview-patient.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/preview-patient"
      },

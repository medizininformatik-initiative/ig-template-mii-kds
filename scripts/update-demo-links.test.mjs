...
const REPO = "https://github.com/medizininformatik-initiative/ig-template-mii-kds";

const PAGE = `<!DOCTYPE html>
<html lang="en"><body>
<h1>ig-template-mii-kds</h1>
<p class="note">Prose that must survive, mentioning demo builds in general.</p>
<h2>Rendered demo — template release v0.5.1</h2>
<p>The template's own preview IG, built with the pinned toolchain:</p>
<ul>
<li><a href="demo/v0.5.1/en/index.html">Demo IG (English)</a></li>
<li><a href="demo/v0.5.1/de/index.html">Demo-IG (Deutsch)</a></li>
...
test("hand-authored prose outside the four anchors is untouched", () => {
  const { html } = rewriteLandingPage(PAGE, { version: "v0.6.0", repoUrl: REPO });
  assert.match(html, /<h1>ig-template-mii-kds<\/h1>/);
...
test("lineDiff reports only genuinely changed lines", () => {
  ...
  assert.ok(!diff.some((l) => l.includes("<h1>ig-template-mii-kds</h1>")));
